...
namespace Takenet.Elephant.Specialized
{
    ...
    public class FallbackPropertyMap<TKey, TValue> : FallbackExecutor<IPropertyMap<TKey, TValue>>, IPropertyMap<TKey, TValue>
    {        
        public FallbackPropertyMap(IPropertyMap<TKey, TValue> primary, IPropertyMap<TKey, TValue> secondary) : base(primary, secondary)
        {
