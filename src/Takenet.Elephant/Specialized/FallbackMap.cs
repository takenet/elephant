...
namespace Takenet.Elephant.Specialized
{
    ...
    public class FallbackMap<TKey, TValue> : FallbackExecutor<IMap<TKey, TValue>>, IMap<TKey, TValue>
    {       
        public FallbackMap(IMap<TKey, TValue> primary, IMap<TKey, TValue> secondary)
