...
{
    internal class ScopedMap<TKey, TValue> : IMap<TKey, TValue>
    {
        ...
        public ScopedMap(IMap<TKey, TValue> map, IScope scope, ISerializer<TKey> keySerializer)
        {
            ...
            _scope.RemoveKeyFunc = k => TryRemoveAsync(_keySerializer.Deserialize(k));            
    ...
    internal class ScopedSetMap<TKey, TValue> : ScopedMap<TKey, ISet<TValue>>, ISetMap<TKey, TValue>
    {
