...
namespace Takenet.SimplePersistence.Sql.Mapping
{
    ...
    {
        public static IDictionary<string, object> GetKeyColumnValues<TEntity>(this ITableMapper<TEntity> tableMapper, TEntity entity)
        {
            return tableMapper.GetColumnValues(entity, tableMapper.KeyColumns.ToArray());
        }
